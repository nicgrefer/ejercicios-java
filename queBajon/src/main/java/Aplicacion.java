...
public class Aplicacion {
	...
	{
		Trabajador t = new Trabajador("Juan", "12345678Z", null);
		Trabajador t2 = new Trabajador("Maria", "13493484Y", null);
		Trabajador t3 = new Trabajador("Pedro", "12345678Z", null);
		Empresa e = new Empresa("Gregorio Fernandez","838383B", null);
