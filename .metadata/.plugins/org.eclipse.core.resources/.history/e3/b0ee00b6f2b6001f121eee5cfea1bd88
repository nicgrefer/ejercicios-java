...
public class Tele {
	...
	// Construcores 
		...
		public Tele(String nSerie, double tamanioPulgada, int nCabales, int nVolumen, boolean encendido) {
			if (nSerie == null || nSerie.isEmpty() || tamanioPulgada <= 0 || nCabales <= 0 ) {
	...
	//
		...
		public String toString() {
			return "La Tele tiene como numero de serie =" + nSerie + ", el tamaño de pulgadas=" + tamanioPulgada + ", nnumeros de cabales=" + nCabales
					+ ", numero del volumen=" + nVolumen + " y esta encendido=?" + encendido  ;
		}
